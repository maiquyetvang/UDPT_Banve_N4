...
public class AuthenticationFiller implements GlobalFilter, Ordered {
    ...
    @NonFinal
    private String[] publicEndpoints = {"/api/auth/.*","/api/auth/users/register","/api/profiles/.*",};
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        //Verify token
        return authenticationService.introspect(token).flatMap(introspectResponseApiResponse -> {
